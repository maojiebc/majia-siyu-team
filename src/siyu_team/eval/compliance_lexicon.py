...
INDUCE_PATTERN = re.compile(
    r"(转发.{0,8}(领|送|得|抽|享|免)|集(?:满|齐|够)?\s*\d*\s*个?赞|拉\s*\d+\s*人|拉够\s*\d+"
...
PRIVACY_PATTERN = re.compile(
    ...
    r"|(手机号|电话|身份证|定位|微信号).{0,6}(发给|给我|留一?下|报一?下|填一?下|提供|登记))"
)
