...
<p align="center">
  <img src="https://raw.githubusercontent.com/maojiebc/majia-siyu-team/main/docs/framework.png" width="520" alt="majia-siyu v1.5.0 architecture: one entry picks the current step; external facts require live evidence; structural issues escalate to a full four-expert review; knowledge pilot stays offline">
</p>
...
- **v1.5.0** (2026-09-14): Store membership execution and scenario retrieval; 41 curated rules, with six scenarios checked in source, wheel and SkillHub packages.
- **v1.4.3**: WorkBuddy expert-team packaging and archive checks.
- **v1.4.2**: Entry, knowledge, privacy and distribution consistency.

Full history: [CHANGELOG](https://github.com/maojiebc/majia-siyu-team/blob/main/CHANGELOG.md).
